function startApp() {
    ...
    const kinveyAppKey = "kid_rJ4nK8A9z";
    const kinveyAppSecret = "6eb1656e3a2c4c36bf3cf2b0c19554d3";
...
//    const APP_KEY = 'kid_rJ4nK8A9z';
//    const APP_SECRET = '6eb1656e3a2c4c36bf3cf2b0c19554d3';
...
//    //$('#buttonEditAd').click(editAd);
//
//    $('#linkHome').click(() => viewSection('Home'));
//    $('#linkListAds').click(() => viewSection('Ads'));
//    $('#linkCreateAd').click(() => viewSection('CreateAd'));
//    $('#linkLogout').click(() => {
//        sessionStorage.clear();
//        showHideMenuLinks();
//        viewSection('Home');
//    });
//    $('#linkLogin').click(() => viewSection('Login'));
//    $('#linkRegister').click(() => viewSection('Register'));
//
...
//        let data = {title: title, description: description, date: date, price: price};
//        $.ajax({
//            type: "POST",
...
//            showHideMenuLinks();
//            viewSection('Ads');
//            $(info).text('Advertisement created successfully')
//        }).catch(error)
//    }
//
//    function showHideMenuLinks() {
